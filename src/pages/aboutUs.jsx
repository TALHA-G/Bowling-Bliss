            ...
            <div className='w-[100%] h-[100vh] px-24 about flex justify-end items-center container mx-auto'>
                <div className='w-[670px] h-[690px] bg-[#363636cc] p-8 text-[#fff]'>
                    ...
                    <div className='flex gap-4 h-10 mt-12 hv'>
                        ...
                        <Link href={'https://twitter.com/bilalbilla009'} target="_blank"><i class="fa-brands fa-x-twitter py-[0.70rem] px-[0.75rem] text-[1.25rem] text-[#000] bg-[#fff] rounded-[50%]"></i></Link>
                    </div>
                </div>
            </div>
        </>
